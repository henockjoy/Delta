...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1001725399753'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002429568959'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001725399753'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1001263870486')  # Channel/Group ID for force sub (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/01c719c53e0e98c3bcb44-7d50040eddfea5a488.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'henockjoy65-1@okaxis')

#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1002328539484').split()]
...
OWNERID = int(os.environ.get('OWNERID', '1824857814'))  # Replace with the actual admin ID
